...
public class FormMahasiswaReport extends JFrame {
    ...
    public FormMahasiswaReport() {
        ...
        setTitle("Form Mahasiswa + Tarik Report");
        setSize(600, 450);
        ...
        txtNama.setBounds(100, 50, 180, 25);
        add(txtNama);

        txtJurusan = new JTextField();
        txtJurusan.setBounds(100, 80, 180, 25);
        add(txtJurusan);

        txtAlamat = new JTextField();
        txtAlamat.setBounds(100, 110, 180, 25);
        add(txtAlamat);

        // ===== BUTTON TAMBAH =====
        btnTambah = new JButton("Tambah Data");
        btnTambah.setBounds(100, 150, 150, 35);
        add(btnTambah);

        // ===== BUTTON TARIK REPORT 🔥 =====
        btnTarik = new JButton("Tarik Report");
        btnTarik.setBounds(270, 150, 180, 35);
        btnTarik.setBackground(java.awt.Color.GREEN);
        btnTarik.setForeground(java.awt.Color.BLACK);
        add(btnTarik);
        ...
        scrollPane.setBounds(20, 210, 540, 170);
        add(scrollPane);
    ...
    // 🧾 TARIK REPORT (PAKAI JRXML)
    private void tarikReport() {
        try {
            String path = "src/laporan/laporan1.jrxml";
            ...
            JOptionPane.showMessageDialog(null, "Gagal tarik report: " + e.getMessage());
        }
    }
